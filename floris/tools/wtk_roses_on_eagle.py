# Make pickled wind rose objects directly on Eagle using Wind Toolkit data
import h5py
import numpy as np
import pandas as pd
import glob
...
def main():
    ...
    for i in range(len(sites['latitude'])):
        ...
        for filename in glob.glob('/datasets/WIND/conus/v1.0.0/wtk_conus_*.h5'): 
        ...
        # Make pickle files at each hub height
